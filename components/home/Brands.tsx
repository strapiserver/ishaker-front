...
const BRAND_SOURCE_URL = `${STRAPI_URL}/api/brands?pagination[page]=1&pagination[pageSize]=2000&sort[0]=updatedAt:desc&populate[logo][fields][0]=url&populate[logo][fields][1]=formats&fields[0]=name`;
